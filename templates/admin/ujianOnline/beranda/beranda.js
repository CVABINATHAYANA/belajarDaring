angular.module('app.berandaUjianOnlineAdmin', [])

    .controller('berandaUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database(appUjianOnline).ref("ujianOnline").orderByChild("idKotaKabupaten").equalTo($scope.idKotaKabupaten);
        ...
        $scope.pengaturanUjian = function (data) {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    if (index === 0) {
                        $state.go('menuAdmin.editUjianOnlineAdmin', {
                            "idUjian": data.$id,
                    ...
                    if (index === 2) {
                        if(data.ruangLingkupUjian==='Sekolah'){
                            //Cek Data
                            var cek = firebase.database(appUjianOnline).ref("pelajaranUjianOnline").orderByChild("idUjian").equalTo(data.$id);
                            ...
                            listCek.$loaded().then(function(response){
                                if(response.length===0){
                                    ...
                                    $state.go('menuAdmin.registrasiPesertaUjianOnlineAdmin', {
                                        "idUjian": data.$id,
                                        "namaUjian": data.namaUjian,
                                        "jenjang": data.jenjang,
                                        "idKelas": data.idKelas,
                    ...
                    if (index === 3) {
                        $state.go('menuAdmin.logHistoriUjianOnlineAdmin', {
                            "idUjian": data.$id,
                            "namaUjian": data.namaUjian,
                            "jenjang": data.jenjang,
                            "namaKelas": data.namaKelas,
                    ...
                    if (index === 4) {
                        $state.go("menuAdmin.nilaiPeringkatUjianOnlineAdmin", {
                ...
                destructiveButtonClicked: function () {
                    if($scope.hakAkses==="Super Admin"){
                        var cek = firebase.database(appUjianOnline).ref("pesertaUjianOnline").orderByChild("idUjian").equalTo(data.$id);
                        var listCek = $firebaseArray(cek);
                        listCek.$loaded().then(function (response) {
                            if (response.length === 0) {
    
                                var refObj = firebase.database(appUjianOnline).ref("ujianOnline/" + data.$id);
        ...
        $scope.tambahUjianOnline = function () {
            $state.go("menuAdmin.tambahUjianOnlineAdmin");
        };

    }])

    .controller('tambahUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.simpan = function () {
            ...
            if($scope.formData.ruangLingkupUjian==="Sekolah"){
                if ($scope.formData.idProvinsi !== "" && $scope.formData.idKotaKabupaten !== "" && $scope.formData.idKecamatan !== "" && $scope.formData.jenjang !== "" && $scope.formData.idSekolah !== "" && $scope.formData.idGuru !== "" && $scope.formData.idTahunAjaran !== "" && $scope.formData.idSemester !== "" && $scope.formData.idKelas !== "" && $scope.formData.namaUjian !== "" && $scope.formData.jumlahPaketSoal !== null) {
                    var ref = firebase.database(appUjianOnline).ref("ujianOnline");
                    ref.push({
                        ...
                        "tingkatKelas": $scope.tingkatKelas,
                        ...
                        "filter": $scope.formData.jenisUjian+"_"+$scope.formData.ruangLingkupUjian+"_"+$scope.tingkatKelas+"_"+$scope.formData.publish
    
                    }).then(function (resp) {
                        console.log(resp.key)
                        //update database
                        var refUpdate = firebase.database(appUjianOnline).ref("ujianOnline/" + resp.key);
                        ...
                        refUpdate.update(JSON.parse(JSON.stringify({
                            ...
                            $state.go("menuAdmin.ujianOnlineAdmin");
                        })
                    })
                }
                else {
    ...
    .controller('editUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var refObj = firebase.database(appUjianOnline).ref("ujianOnline/" + $scope.data.idUjian);
        ...
        obj.$loaded().then(function (response) {
            ...
            var refKecamatan = firebase.database().ref("kecamatan").orderByChild("id_kota_kabupaten").equalTo(response.idKotaKabupaten);
            var listRefKecamatan = $firebaseArray(refKecamatan);
            $ionicLoading.show();
            listRefKecamatan.$loaded().then(function (response) {
                $ionicLoading.hide();
            ...
            var refKelas = firebase.database(appJadwalPelajaran).ref("jadwalPelajaran/").orderByChild("filterGuru").equalTo(response.idSekolah + "_" + response.idGuru + "_" + response.idTahunAjaran);
            var listRefKelas = $firebaseArray(refKelas);
            listRefKelas.$loaded().then(function (response) {
                $scope.datanya = response
                $scope.dataKelas = $scope.datanya.groupBy('namaKelas');
            ...
            var refKelas = firebase.database(appJadwalPelajaran).ref("jadwalPelajaran").orderByChild("filterPelajaran").equalTo(response.idSekolah + "_" + response.idGuru + "_" + response.idTahunAjaran + "_" + response.idKelas);
            var listRefKelas = $firebaseArray(refKelas);
            listRefKelas.$loaded().then(function (response) {
                $scope.datanya = response
                $scope.dataPelajaran = $scope.datanya.groupBy('pelajaran');
        ...
        $scope.simpan = function () {
            if($scope.formData.ruangLingkupUjian==="Sekolah"){
                if ($scope.formData.idProvinsi !== "" && $scope.formData.idKotaKabupaten !== "" && $scope.formData.idKecamatan !== "" && $scope.formData.jenjang !== "" && $scope.formData.idSekolah !== "" && $scope.formData.idGuru !== "" && $scope.formData.idTahunAjaran !== "" && $scope.formData.idSemester !== "" && $scope.formData.idKelas !== "" && $scope.formData.namaUjian !== "" && $scope.formData.jumlahPaketSoal !== null) {
                    ...
                    $ionicLoading.show();
                    var updateData = firebase.database(appUjianOnline).ref("ujianOnline/" + $scope.data.idUjian);
