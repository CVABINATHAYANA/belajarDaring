angular.module('app.pengaturanUmumUjianOnlineAdmin', [])

    .controller('pengaturanUmumUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var data = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline").orderByChild("filter").equalTo($scope.data.idUjian + "_" + $scope.data.idPelajaranUjianOnline);
        var listData = $firebaseArray(data);

        listData.$loaded().then(function (response) {
            // console.log(response);
            if (response.length === 1) {
                var dataObject = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline/" + response[0].$id);
                ...
                for (i = 0; i < response.length; i++) {
                    if (i > 0) {
                        var obj = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline/" + response[i].$id);
        ...
        $scope.simpan = function () {
            if ($scope.formData.tanggalUjian !== null && $scope.formData.jamUjian !== null && $scope.formData.durasiUjian !== null && $scope.formData.nilaiMaksimum !== null && $scope.formData.jumlahSoal !== null && $scope.formData.kkm !== null) {
                ...
                var cekData = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline").orderByChild("filter").equalTo($scope.data.idUjian + "_" + $scope.data.idPelajaranUjianOnline);
                ...
                listCekData.$loaded().then(function (response) {
                    if (response.length === 0) {
                        ...
                        var addData = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline");
                        ...
                        addData.push({
                            ...
                            $state.go("menuAdmin.pelajaranUjianOnlineAdmin", {
                                "idUjian": $stateParams.idUjian,
                                "namaUjian": $stateParams.namaUjian,
                                "jenjang": $stateParams.jenjang,
                                "namaKelas": $stateParams.namaKelas,
                        ...
                        var hariUjian = $filter('date')($scope.formData.tanggalUjian, 'EEEE');
                        var refUpdate = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline/" + $scope.formData.id);
                        var tanggalUjianDisplay = $filter('date')($scope.formData.tanggalUjian, 'dd-MM-yyyy');
                        var jamUjianDisplay = $filter('date')($scope.formData.jamUjian, 'HH:mm');
                        ...
                        refUpdate.update(JSON.parse(JSON.stringify({
                            ...
                            var updateJawabanOlimpiadeSiswaPerPelajaran = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswaPerPelajaran").orderByChild("idPelajaranUjianOnline").equalTo($scope.data.idPelajaranUjianOnline);
                            ...
                            listUpdateJawabanOlimpiadeSiswaPerPelajaran.$loaded().then(function (response) {
                                for (i = 0; i < response.length; i++) {
                                    ...
                                    var updateData = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswaPerPelajaran/" + response[i].$id);
    ...
    .controller('kisiKisiSoalUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var cekData = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline").orderByChild("filter").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
        var listCekData = $firebaseArray(cekData);

        listCekData.$loaded().then(function (response) {

            if (response.length === 0) {
                var add = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline").push({
                    ...
                    var id = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline").orderByChild("filter").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
                    id.on("child_added", function (snapshot) {
                        $scope.idKisiKisi = snapshot.key;
                    });

                    var refKisi = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline/" + $scope.idKisiKisi + "/kisiKisi");
            ...
            $ionicModal.fromTemplateUrl('templates/modal.html', {
                ...
                $scope.simpan = function () {
                    if ($scope.formData.materiPelajaran !== '' && $scope.formData.ruangLingkup !== '') {
                        $ionicLoading.show();
                        var add = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline/" + $scope.idKisiKisi + "/kisiKisi").push($scope.formData).then(function (resp) {
                            $ionicLoading.hide();
                            $scope.modal.hide();
                            //console.log("success")
                ...
                buttonClicked: function (index) {
                    if (index === 0) {
                        ...
                        $ionicModal.fromTemplateUrl('templates/modal.html', {
                            ...
                            var refObj = firebase.database(appUjianOnline).ref("kisiKisiSoalUjianOnline/" + $scope.idKisiKisi + "/kisiKisi/" + data.$id);
    ...
    .controller('resetJawabanPesertaUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.getDataHapus = function (data) {
            ...
            confirmPopup.then(function (res) {
                if (res) {
                    ...
                    var jawabanOlimpiadeSiswa = firebase.database(appUjianOnline).ref("jawabanUjianOnlineeSiswa").orderByChild("filter").equalTo($scope.data.idUjian + "_" + $scope.data.idPelajaranUjianOnline + "_" + data.uid);
                    ...
                    refJawabanOlimpiadeSiswa.$loaded().then(function (response) {
                        for (i = 0; i < response.length; i++) {
                            ...
                            var updateJawabanOlimpiadeSiswa = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswa/" + id);
                    ...
                    var jawabanOlimpiadeSiswaPerPelajaran = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswaPerPelajaran").orderByChild("filter").equalTo($scope.data.idUjian + "_" + $scope.data.idPelajaranUjianOnline + "_" + data.uid);
                    ...
                    refJawabanOlimpiadeSiswaPerPelajaran.$loaded().then(function (response) {
                        for (i = 0; i < response.length; i++) {
                            ...
                            var updateJawabanOlimpiadeSiswaPerPelajaran = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswaPerPelajaran/" + id);
    ...
    .controller('tambahSoalUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var jumlahSoal = firebase.database(appUjianOnline).ref("pengaturanUmumUjianOnline").orderByChild("filter").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    if (index === 0) {
                        ...
                        var cekSoal = firebase.database(appUjianOnline).ref("soalUjianOnline").orderByChild("filter").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline + "_" + data.$id);
                        var listCekSoal = $firebaseArray(cekSoal);

                        listCekSoal.$loaded().then(function (response) {
                            if (response.length === 0) {

                                var filterJumlahSoal = firebase.database(appUjianOnline).ref("soalUjianOnline").orderByChild("filterJumlahSoal").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
                                ...
                                listFilterJumlahSoal.$loaded().then(function (callBack) {
                                    ...
                                    if ($scope.jumlahSoalSekarang <= $scope.totalSoalUjian) {
                                        $ionicLoading.show()
                                        var addSoal = firebase.database(appUjianOnline).ref("soalUjianOnline");
                                        addSoal.push({
                                            "idUjian": $stateParams.idUjian,
                                            "namaUjian": $stateParams.namaUjian,
                                            "jenjang": $stateParams.jenjang,
                                            ...
                                            $ionicLoading.hide();
                                            var cekSoal = firebase.database(appUjianOnline).ref("soalUjianOnline").orderByChild("filterJumlahSoal").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
                                            var listCekSoal = $firebaseArray(cekSoal);
        ...
        $scope.cekSoal = function () {
            $state.go('menuAdmin.soalUjianOnlineDetailAdmin', {
                "idUjian": $stateParams.idUjian,
                "namaUjian": $stateParams.namaUjian,
                "jenjang": $stateParams.jenjang,
                "namaKelas": $stateParams.namaKelas,
    ...
    .controller('soalUjianOnlineDetailAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database(appUjianOnline).ref("soalUjianOnline").orderByChild("filterJumlahSoal").equalTo($stateParams.idUjian + "_" + $stateParams.idPelajaranUjianOnline);
        ...
        $scope.getData = function (data) {
            ...
            $ionicActionSheet.show({
                ...
                destructiveButtonClicked: function () {
                    var refObj = firebase.database(appUjianOnline).ref("soalUjianOnline/" + data.idSoalUjianOnline);
                    var objDelete = $firebaseObject(refObj);
                    var confirmPopup = $ionicPopup.confirm({
                        title: 'Hapus Data',
    ...
    .controller('ulangUjianOnlineAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.getDataHapus = function (data) {
            ...
            confirmPopup.then(function (res) {
                if (res) {
                    ...
                    //Menghapus Jawaban Olimpiade Siswa
                    var jawabanOlimpiadeSiswa = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswa").orderByChild("filter").equalTo($scope.data.idUjian + "_" + $scope.data.idPelajaranUjianOnline + "_" + data.uid);
                    var refJawabanOlimpiadeSiswa = $firebaseArray(jawabanOlimpiadeSiswa);
                    ...
                    refJawabanOlimpiadeSiswa.$loaded().then(function (response) {
                        for (i = 0; i < response.length; i++) {
                            ...
                            var hapusJawabanOlimpiadeSiswa = firebase.database(appUjianOnline).ref("jawabanUjianOnlineSiswa/" + id);
