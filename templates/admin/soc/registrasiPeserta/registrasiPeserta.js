angular.module('app.registrasiPesertaSOCAdmin', [])

    .controller('registrasiPesertaSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
                            ...
                            if (response.length === 0) {
                                ...
                                refAdd.push({
                                    ...
                                    tambahData.push({
                                        ...
                                        var addData = firebase.database().ref("pengaturanUmumUjian").orderByChild("idTryout").equalTo($scope.data.idTryout);
                                        ...
                                        listAddData.$loaded().then(function (response) {
                                            for (i = 0; i < response.length; i++) {
                                                ...
                                                tambahData.push({
                                                    ...
                                                    "semester": $stateParams.semester,
                                                    "tahunAjaran": $stateParams.tahunAjaran,
                                                    "idPelajaranTryout": response[i].idPelajaranTryout,
                                                    ...
                                                    "filter": $stateParams.idTryout + "_" + response[i].idPelajaranTryout + "_" + data.uid,
    ...
    .controller('pesertaTeregistrasiSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('logHistoriSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
