angular.module('app.nilaiPeringkatSOCAdmin', [])

    .controller('nilaiPeringkatSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        //             template: "Koneksi Internet Anda Terputus, Silahkan Periksa Koneksi Jaringan Anda, Terimakasih",
        ...
        $scope.dataNilaiSiswa = function (data) {
            //console.log(data);
            $state.go("menuAdmin.nilaiSiswaSOCAdmin", {
                "idTryout": $stateParams.idTryout,
                "namaTryout": $stateParams.namaTryout,
                "jenjang": $stateParams.jenjang,
                "olimpiadeTingkat": $stateParams.olimpiadeTingkat,
    ...
    .controller('nilaiSiswaSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $ionicLoading.show()
        var dataSiswa = firebase.database().ref("dataSiswa").orderByChild("uid").equalTo($scope.data.uid);
        ...
        $scope.goToNilai = function (data) {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    if (index === 0) {
                        ...
                        getData.on("child_added", function (snapshot) {
                            ...
                            $state.go("menuAdmin.nilaiSiswaDetailSOCAdmin", {
                                "idTryout": $stateParams.idTryout,
                                "namaTryout": $stateParams.namaTryout,
                                "jenjang": $stateParams.jenjang,
                                "olimpiadeTingkat": $stateParams.olimpiadeTingkat,
                ...
                destructiveButtonClicked: function () {
                    var refNilai = firebase.database().ref("rekapJawabanOlimpiadeSiswa/" + $scope.data.idRekapJawabanOlimpiadeSiswa + "/pelajaran/" + data.$id);
    ...
    .controller('nilaiSiswaDetailSOCAdminlCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('statusJawabanSiswaSOCAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
