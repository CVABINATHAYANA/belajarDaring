angular.module('app.materiPelajaranAdmin', ['ngYoutubeEmbed'])

    .controller('materiPelajaranAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.tambah = function () {
            $state.go("menuAdmin.materiPelajaranTambahAdmin");
        }
        ...
        var ref = firebase.database(appMateriPelajaran).ref("materiPelajaran");
        var listRef = $firebaseArray(ref);
        $ionicLoading.show();
        listRef.$loaded().then(function (response) {
            $ionicLoading.hide();
            $scope.dataSoalAdmin = response
            $scope.dataSoal = $scope.dataSoalAdmin.groupBy('pelajaran');
            // console.log($scope.dataSoal)
        });

        $scope.getData = function (x, y) {
            $state.go('menuAdmin.materiPelajaranPerJenjangAdmin', {
                "pelajaran": x,
    ...
    .controller('materiPelajaranTambahAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.simpan = function () {
            ...
            var tanggal = $filter('date')($scope.formData.createAt, 'yyyy-MM-dd HH:mm:ss');
            ...
            if ($scope.formData.jenjang !== '' && $scope.formData.kelas !== '' && $scope.formData.idPelajaran !== '') {
                ...
                add.push({
                    ...
                    console.log("success");
                    $state.go("menuAdmin.materiPelajaranAdmin");
                    $ionicPopup.alert({
                        title: 'SUKSES',
    ...
    .controller('materiPelajaranSubBABAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.tambahSubBAB = function () {
            ...
            $state.go('menuAdmin.materiPelajaranSubBABTambahAdmin', {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    ...
                    if (index === 0) {
                        ...
                        $state.go('menuAdmin.materiPelajaranSubBABEditAdmin', {
                            "idMateriPelajaran": $scope.data.idMateriPelajaran,
                            "BAB": $scope.data.BAB,
                            "idSubBAB": item.$id,
    ...
    .controller('materiPelajaranSubBABTambahAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.simpan = function () {
            ...
            if ($scope.formData.namaSubBAB !== "" && $scope.formData.isiMateriPembelajaran !== "") {
                ...
                ref.push({
                    ...
                    $ionicLoading.hide();
                    $state.go('menuAdmin.materiPelajaranSubBABAdmin', {
                        "idMateriPelajaran": $stateParams.idMateriPelajaran,
                        "BAB": $stateParams.BAB
                    })
                })
    ...
    .controller('materiPelajaranSubBABEditAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('materiPelajaranEditAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('materiPelajaranPerJenjangAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database(appMateriPelajaran).ref("materiPelajaran").orderByChild("idPelajaran").equalTo($scope.data.idPelajaran);
        var listRef = $firebaseArray(ref);
        $ionicLoading.show();
        listRef.$loaded().then(function (response) {
            $ionicLoading.hide();
        ...
        $scope.getData = function (x, y) {
            $state.go('menuAdmin.materiPelajaranLihatAdmin', {
    ...
    .controller('materiPelajaranLihatAdminCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database(appMateriPelajaran).ref("materiPelajaran").orderByChild("filter").equalTo($scope.data.idPelajaran + "_" + $scope.data.kelas);
        var listRef = $firebaseArray(ref);
        $ionicLoading.show();
        listRef.$loaded().then(function (response) {
            $ionicLoading.hide();
        ...
        $scope.getData = function (data) {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    ...
                    if (index === 1) {
                        $state.go('menuAdmin.materiPelajaranEditAdmin', {
                            "idMateriPelajaran": data.$id
                        });
                    }
