angular.module('app.nilaiPeringkatUTSUASGuru', [])

    .controller('nilaiPeringkatUTSUASGuruCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.totalData = [];
        var totalData = firebase.database(app).ref("rekapJawabanUTSUASSiswa").orderByChild("idUTSUAS").equalTo($scope.data.idUTSUAS);
        ...
        if ($scope.data.utsUasTingkat === 'Sekolah') {
            ...
            $scope.getIdKelas = function () {
                ...
                var ref = firebase.database(app).ref("rekapJawabanUTSUASSiswa").orderByChild("filterIdUtsUasIdKelas").equalTo($scope.data.idUTSUAS + "_" + $scope.formData.idKelas);
        ...
        $scope.goToNilai = function (data) {
            $state.go("menuGuru.nilaiSiswaDetailUTSUASGuru", {
        ...
        var ref = firebase.database(app).ref("rekapJawabanUTSUASSiswa").orderByChild("filterIdUTSUASKecamatanIdSekolah").equalTo($scope.data.idUTSUAS+"_"+$scope.idKecamatanGuru+"_"+$scope.idSekolahGuru);
        var listRef = $firebaseArray(ref);
        ...
        $scope.dataNilaiSiswa = function (data) {
            //console.log(data);
            $state.go("menuGuru.nilaiSiswaUTSUASGuru", {
                "idUTSUAS": $stateParams.idUTSUAS,
                "namaUTSUAS": $stateParams.namaUTSUAS,
                "jenjang": $stateParams.jenjang,
                "utsUasTingkat": $stateParams.utsUasTingkat,
    ...
    .controller('nilaiSiswaUTSUASGuruCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('nilaiSiswaDetailUTSUASGuruCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
    ...
    .controller('statusJawabanSiswaUTSUASGuruCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
