angular.module('app.tugasOrangTua', [])

    .controller('tugasSiswaPerMapelOrangTuaCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        ref.on('value', function (snapshot) {
            ...
            listRef.$loaded().then(function (response) {
                ...
                $scope.goToTugas = function(data){
                    ...
                    $state.go('menuOrangTua.tugasSiswaOrangTua',{
                        "idMapel": data.$id,
                    }
                    )
                }
    ...
    .controller('tugasSiswaOrangTuaCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
            ...
            $scope.getData = function (data) {
                $ionicActionSheet.show({
                    ...
                    buttonClicked: function (index) {
                        if (index === 0) {
                            $state.go("menuOrangTua.tugasSiswaLihatOrangTua", {
                                "idTugas": data.$id,
                        ...
                        if (index === 1) {
                            $state.go("menuOrangTua.tugasSiswaDiskusiOrangTua", {
                                "idTugas": data.$id,
                                "pelajaran": data.pelajaran,
                                "groupTugas": data.groupTugas,
    ...
    .controller('uploadFileTugasOrangTuaCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', '$firebaseStorage', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter, $firebaseStorage) {
    ...
    .controller('tugasSiswaDiskusiOrangTuaCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', '$firebaseStorage', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter, $firebaseStorage) {
