angular.module('app.berandaLatihanSoalOnlineSiswaUmum', [])

    .controller('berandaLatihanSoalOnlineSiswaUmumCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        refSiswa.on("value", function (snapshot) {
            ...
            var reflatihanSoal = firebase.database(app).ref("ujianOnline").orderByChild("filter").equalTo("Latihan Soal Online_Umum" + "_" + $scope.tingkatKelas + "_true");
