angular.module('app.berandaTryoutOnlineSiswaUmum', [])

    .controller('berandaTryoutOnlineSiswaUmumCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        refSiswa.on("value", function (snapshot) {
            ...
            var reflatihanSoal = firebase.database(app).ref("ujianOnline").orderByChild("filter").equalTo("Tryout Online_Umum" + "_" + $scope.tingkatKelas+"_true");
