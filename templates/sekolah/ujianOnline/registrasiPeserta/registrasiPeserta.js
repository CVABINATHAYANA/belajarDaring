angular.module('app.registrasiPesertaUjianOnlineSekolah', [])

    .controller('registrasiPesertaUjianOnlineSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    if (index === 0) {
                        ...
                        var refPesertaOlimpiade = firebase.database(app).ref("pesertaUjianOnline").orderByChild("filter").equalTo(data.uid + "_" + $scope.data.idUjian);
        ...
        $scope.pesertaTeregistrasi = function () {
            $state.go('menuSekolah.pesertaTeregistrasiUjianOnlineSekolah', {
                "idUjian": $stateParams.idUjian,
                "namaUjian": $stateParams.namaUjian,
                "jenjang": $stateParams.jenjang,
                "idKelas": $stateParams.idKelas,
                ...
                destructiveButtonClicked: function () {
                    ...
                    confirmPopup.then(function (res) {
                        if (res) {
                            ...
                            var a = firebase.database(app).ref("jawabanUjianOnlineSiswa").orderByChild("filterHapusRegistrasi").equalTo($stateParams.idUjian + "_" + data.uid);
                            var listA = $firebaseArray(a);
                            listA.$loaded().then(function (response) {

                                for (i = 0; i < response.length; i++) {

                                    var a1 = firebase.database(app).ref("jawabanUjianOnlineSiswa/" + response[i].$id);
                            ...
                            var b = firebase.database(app).ref("jawabanUjianOnlineSiswaPerPelajaran").orderByChild("filterMulaiUjian").equalTo($stateParams.idUjian + "_" + data.uid);
                            var listB = $firebaseArray(b);
                            listB.$loaded().then(function (response) {

                                for (i = 0; i < response.length; i++) {

                                    var b1 = firebase.database(app).ref("jawabanUjianOnlineSiswaPerPelajaran/" + response[i].$id);
                            ...
                            var c = firebase.database(app).ref("rekapJawabanUjianOnlineSiswa").orderByChild("filter").equalTo($stateParams.idUjian + "_" + data.uid);
                            ...
                            listC.$loaded().then(function (response) {
                                if (response.length === 0) {
                                    ...
                                    var c1 = firebase.database(app).ref("rekapJawabanUjianOnlineSiswa/" + response[0].$id);
                            ...
                            var refObj = firebase.database(app).ref("pesertaUjianOnline/" + data.$id);
    ...
    .controller('registrasiPesertaKotaSOCSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        $scope.pesertaTeregistrasi = function () {
            $state.go('menuSekolah.pesertaTeregistrasiSOCSekolah', {
                "idTryout": $stateParams.idTryout,
                "namaTryout": $stateParams.namaTryout,
                "jenjang": $stateParams.jenjang,
                "kelas": $stateParams.kelas,
    ...
    .controller('logHistoriUjianOnlineSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database(app).ref("jawabanUjianOnlineSiswaPerPelajaran").orderByChild("idUjian").equalTo($scope.data.idUjian);
