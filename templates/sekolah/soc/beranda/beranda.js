angular.module('app.berandaSekolahSOC', [])

    .controller('berandaSOCSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
        ...
        var ref = firebase.database().ref("namaTryout").orderByChild("id_kota_kabupaten").equalTo($scope.idKotaKabupatenSekolah);
        ...
        $scope.pengaturanTryout = function (data) {
            ...
            $ionicActionSheet.show({
                ...
                buttonClicked: function (index) {
                    // if (index === 0) {
                    //     $state.go('menuSekolah.editSOCSekolah', {
                    //         "idTryout": data.$id,
                    ...
                    //         $state.go('menuSekolah.registrasiPesertaKotaSOCSekolah', {
                    //             "idTryout": data.$id,
                    //             "namaTryout": data.namaTryout,
                    //             "jenjang": data.jenjang,
                    //             "kelas": data.kelas,
                    ...
                    //     }
                    //     else {
                    //         $state.go('menuSekolah.registrasiPesertaSOCSekolah', {
                    //             "idTryout": data.$id,
                    //             "namaTryout": data.namaTryout,
                    //             "jenjang": data.jenjang,
                    //             "kelas": data.kelas,
                    ...
                    // }
                    // if (index === 3) {
                    //     $state.go('menuSekolah.logHistoriSOCSekolah', {
                    //         "idTryout": data.$id,
                    //         "namaTryout": data.namaTryout,
                    //         "jenjang": data.jenjang,
                    //         "kelas": data.kelas,
                    ...
                    // }
                    if (index === 0) {
                        $state.go("menuSekolah.nilaiPeringkatSOCSekolah", {
        ...
        $scope.tambahTryout = function () {
            $state.go("menuSekolah.tambahSOCSekolah");
        };

    }])


    .controller('tambahSOCSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
                ...
                add.$add({
                    ...
                    getID.on("child_added", function (snapshot) {
                        ...
                        refUpdate.update(JSON.parse(JSON.stringify({
                            ...
                            //console.log('success');
                            $state.go("menuSekolah.socSekolah");
                        })
    ...
    .controller('editSOCSekolahCtrl', ['$scope', '$stateParams', '$firebaseArray', '$firebaseObject', '$ionicPopup', '$ionicLoading', '$state', '$ionicModal', '$ionicActionSheet', '$timeout', '$filter', function ($scope, $stateParams, $firebaseArray, $firebaseObject, $ionicPopup, $ionicLoading, $state, $ionicModal, $ionicActionSheet, $timeout, $filter) {
